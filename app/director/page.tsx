...
export default function DirectorPage() {
    const director = {
        ...
        bio: `With a keen eye for detail, the director of BIOBUILD, Architect Mir Ashiqur Rahman, has a hunger for innovative and sustainable solutions that meet the needs of people and environment.

At the heart of Architect Mir Ashiqur Rahman’s philosophy is the belief that every building should be designed with the end user in mind, and a well designed building can positively impact the lives of those use it.

Here at BIOBUILD, he’s responsible for planning & designing, directing and coordinating activities, monitoring performance, ensuring construction standards and overseeing other parts of the construction project.`,
        imageUrl: "/img/bod/bod-04.png", // Replace with your image path
